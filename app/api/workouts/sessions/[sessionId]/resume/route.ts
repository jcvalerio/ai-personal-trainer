/**
 * Session Resume API
 * Handles resuming paused workout sessions
 */
...
export async function POST(
  ...
  try {
    ...
    // Resume the session
    const result = await workoutService.resumeWorkoutSession(sessionId, serviceContext);
...
/**
 * OPTIONS /api/workouts/sessions/[sessionId]/resume
