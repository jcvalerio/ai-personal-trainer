...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Syncing workout data for user:', userId, 'session:', syncData.sessionId)
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.log('Clearing sync data for user:', userId, sessionId ? `session: ${sessionId}` : 'all sessions')
