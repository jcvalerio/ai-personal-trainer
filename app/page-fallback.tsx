      ...
      <footer className='bg-gray-900 text-white'>
        <div className='container-safe py-12'>
          <div className='grid grid-cols-1 gap-8 md:grid-cols-4'>
            ...
            <div className='col-span-1 md:col-span-2'>
              <div className='mb-4 flex items-center space-x-2'>
                ...
                <span className='text-lg font-semibold'>Personal Trainer</span>
              </div>
              <p className='max-w-md text-sm text-gray-400'>
                Transform your fitness journey with AI-powered workout plans,
                progress tracking, and personalized coaching for families and
                gyms.
              </p>
            </div>
          ...
          <div className='mt-8 border-t border-gray-800 pt-8 text-center text-sm text-gray-400'>
            <p>
              &copy; {new Date().getFullYear()} AI Personal Trainer. All rights
              reserved.
            </p>
          </div>
        </div>
