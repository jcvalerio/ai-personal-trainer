...
export function CreateOrganization({ onBack, onSuccess }: CreateOrganizationProps) {
  ...
  const organizationTypes = [
    {
      ...
      icon: Users,
      title: 'Family Group',
      description: 'Create a private group for family members to train together',
      features: ['Up to 10 members', 'Private workouts', 'Family challenges', 'Progress sharing'],
      maxMembers: 10,
    },
    {
      ...
      features: ['Up to 100 members', 'Equipment tracking', 'Class scheduling', 'Analytics'],
      maxMembers: 100,
    },
  ]
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(`${selectedType === 'family' ? 'Family group' : 'Gym'} created successfully!`)
            ...
            {organizationTypes.map((org) => {
              ...
              return (
                <div
                  key={org.type}
                  className={cn(
                    'p-6 border-2 rounded-lg cursor-pointer transition-all hover:border-blue-300',
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">{org.title}</h3>
      ...
      {step === 'details' && selectedType && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Provide information about your {selectedType === 'family' ? 'family group' : 'gym'}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  type="text"
                  required
                  placeholder={selectedType === 'family' ? 'Smith Family Fitness' : 'Downtown Gym'}
                  value={formData.name}
              ...
              <div>
                ...
                <textarea
                  id="description"
                  rows={3}
                  placeholder={selectedType === 'family' ? 'A place for our family to stay fit together' : 'Your neighborhood fitness center'}
              ...
              <div className="flex justify-between pt-6">
                ...
                <Button type="submit" disabled={isLoading}>
                  {isLoading ? (
                    ...
                    <>Create {selectedType === 'family' ? 'Family Group' : 'Gym'}</>
                  )}
                </Button>
              </div>
            </form>
