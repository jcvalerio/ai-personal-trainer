...
export function useAuthGuard() {
  ...
  const hasCompletedOnboarding = user?.publicMetadata?.hasCompletedOnboarding as boolean
  const userRole = user?.publicMetadata?.role as UserRole
  const organizationType = user?.publicMetadata?.organizationType as OrganizationType
  ...
  const hasOrganizationType = (types: OrganizationType | OrganizationType[]) => {
    if (!organizationType) {
      return false
    }
