...
export interface UpdateEquipmentRequest
  extends Partial<CreateEquipmentRequest> {
...
export interface UpdateWorkoutPlanRequest
  extends Partial<CreateWorkoutPlanRequest> {
  status?: WorkoutStatus;
  [key: string]: any; // Allow dynamic property access for sanitization
}
...
export interface UpdateWorkoutSessionRequest
  extends Partial<CreateWorkoutSessionRequest> {
  status?: SessionStatus;
  completionPercentage?: number;
  effortRating?: number;
  energyLevelBefore?: number;
...
export interface UpdateProgressMeasurementRequest
  extends Partial<CreateProgressMeasurementRequest> {}
...
export type WorkoutPlanInput = Omit<
  WorkoutPlan,
  'id' | 'createdAt' | 'updatedAt'
>;
export type WorkoutSessionInput = Omit<
  WorkoutSession,
  'id' | 'createdAt' | 'updatedAt'
>;
