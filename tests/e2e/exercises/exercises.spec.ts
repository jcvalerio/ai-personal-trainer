...
test.describe('Exercise Library', () => {
  ...
  test('should display exercise library or empty state', async ({ page }) => {
    ...
    const hasExercises = await exercisesPage.elementExists('[data-testid="exercise-card"], .exercise-item')
    const hasEmptyState = await exercisesPage.elementExists('[data-testid="empty-state"], .empty-state')
  ...
  test('should filter exercises by category if available', async ({ page }) => {
    const filterSelect = page.locator('select[data-testid="category-filter"], select:has(option)')
  ...
  test('should display exercise details if available', async ({ page }) => {
    const exerciseCards = page.locator('[data-testid="exercise-card"], .exercise-item')
  ...
  test('should handle exercise categories', async ({ page }) => {
    const categoryButtons = page.locator('[data-testid="category-button"], .category-filter button')
...
test.describe('Exercise Details', () => {
  test('should display exercise information', async ({ page }) => {
    ...
    const exerciseCards = page.locator('[data-testid="exercise-card"], .exercise-item, a[href*="exercise"]')
    const cardCount = await exerciseCards.count()
  ...
  test('should handle exercise media if available', async ({ page }) => {
    ...
    const mediaElements = page.locator('img, video, [data-testid="exercise-media"]')
...
test.describe('Exercise Integration', () => {
  test('should add exercise to workout if functionality exists', async ({ page }) => {
    const exercisesPage = new BasePage(page)
    ...
    const addButtons = page.locator('button:has-text("Add"), button[data-testid="add-to-workout"]')
  ...
  test('should navigate between exercises and workouts', async ({ page }) => {
    ...
    const workoutLinks = page.locator('a[href*="/workouts"], a:has-text("Workout")')
