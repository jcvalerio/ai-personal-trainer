...
test.describe('Dashboard Functionality', () => {
  ...
  test('should display welcome message', async ({ page }) => {
    ...
    if (welcomeMessage) {
      ...
      expect(welcomeMessage.toLowerCase()).toMatch(/(welcome|dashboard|hello)/i)
    }
  })
  ...
  test('should display navigation menu', async ({ page }) => {
    ...
    if (hasNavigation) {
      ...
      const hasExpectedItems = expectedItems.some(item => navText.includes(item))
  ...
  test('should be responsive on mobile viewport', async ({ page }) => {
    ...
    const hasNavigation = hasMobileMenu || await dashboardPage.hasNavigationMenu()
...
test.describe('Dashboard Performance', () => {
  ...
  test('should handle concurrent navigation', async ({ page }) => {
    ...
    try {
      ...
      console.log('Concurrent navigation test skipped - navigation not available')
    }
  })
})