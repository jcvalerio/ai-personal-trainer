...
test.describe('Final E2E Setup Validation', () => {
  ...
  test('should validate test credentials are available in CI/production', async () => {
    ...
    console.log(
      'CLERK_CLAUDE_TEST_USER_EMAIL:',
      process.env.CLERK_CLAUDE_TEST_USER_EMAIL ? '✅ Set' : '❌ Not set'
    );
    console.log(
      'CLERK_CLAUDE_TEST_USER_PASSWORD:',
      process.env.CLERK_CLAUDE_TEST_USER_PASSWORD ? '✅ Set' : '❌ Not set'
    );
